...
public class GameBoard extends GameController{
    ...
    public GameBoard(ImageView player1mover, ImageView player1token, ImageView player2mover, ImageView player2token,
        ...
        int[][] laddersNormal = {{2, 23}, {8, 12}, {16, 46}, {29, 54}, {40, 61}, {44, 65}, {62, 78}, {70, 89}, {75, 96}};
        Ladder ladders2 = new Ladder(laddersNormal);
        int[][] snakes = {{98, 36}, {92, 55}, {69, 50}, {59, 37}, {42, 19}, {31, 14}};
        Snake snakes1 = new Snake(snakes);
        this.powerElements = new PowerElement[2];
        this.powerElements[0] = snakes1;
        this.powerElements[1] = ladders2;
